  ...
  return (
    <div className="p-4 border-b border-gray-200">
      <div className="flex justify-between items-center mb-4">
        ...
        <span className="text-sm text-red-500">{selectedDays.length}/{maxSelections}</span>
      </div>
        ...
        <div className="grid grid-cols-4 gap-2 mb-4">
          {workDayOptions.map((option) => (
            <button
              ...
              disabled={!selectedDays.includes(option.id) && selectedDays.length >= maxSelections}
              className={`
                ...
                ${!selectedDays.includes(option.id) && selectedDays.length >= maxSelections
